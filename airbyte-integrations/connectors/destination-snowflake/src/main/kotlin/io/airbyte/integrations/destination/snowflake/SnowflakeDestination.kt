...
constructor(
    ...
    class SnowflakeOperations(val client: SnowflakeStagingClient): JdbcSqlOperations(), StagingOperations {
        override fun insertRecordsInternal(database: JdbcDatabase, records: List<PartialAirbyteMessage>, schemaName: String?, tableName: String?) {
        ...
        override fun copyIntoTableFromStage(
            ...
            client.copyIntoTableFromStage(database, stageName, stagingPath, stagedFiles, tableName, tableName)
        }
        ...
        override fun dropStageIfExists(database: JdbcDatabase?, stageName: String?, stagingPath: String?) {
